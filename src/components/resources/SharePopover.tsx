...
export default function SharePopover({ title }: { title: string }) {
  ...
  // Captured when the popover opens rather than during render: reading
  // window.location while rendering makes the server and first client render
  // disagree, and reading it in an effect just moves the problem to a
  // cascading render.
