...
export default function CareerCta() {
  return (
    <section className="bg-highlight py-10 px-6">
      <div className="site-container">
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/contact-us"
            className="inline-flex items-center gap-2 border border-primary text-primary font-bold text-sm px-6 py-3 rounded-lg hover:bg-white/10 transition-all duration-200 hover:-translate-y-0.5"
          >
